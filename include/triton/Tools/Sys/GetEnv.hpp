...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    ...
    "TRITON_ENABLE_OLD_WS_ANALYSIS",
    "PARTITION_ANALYSIS_ENABLE_DUMP",
    "PARTITION_ANALYSIS_ENABLE_DUMP_DOT",
    "PARTITION_ANALYSIS_DUMP_DATA_ONLY",
    "PARTITION_ANALYSIS_DUMP_LOOP_ONLY",
    "PARTITION_ANALYSIS_NVWS_SERIALIZATION",
    "PARTITION_ANALYSIS_DISABLE_SIMT_GROUPS",
    "PARTITION_ANALYSIS_DISABLE_EPILOGUE_GROUPS",
    "PARTITION_ANALYSIS_DISABLE_REG_COUNT",
    "PARTITION_ANALYSIS_LOAD_NUM_WARPS",
    "PARTITION_ANALYSIS_LOAD_REG_COUNT",
    "PARTITION_ANALYSIS_MMA_NUM_WARPS",
    "PARTITION_ANALYSIS_MMA_REG_COUNT"
    // clang-format on
};
